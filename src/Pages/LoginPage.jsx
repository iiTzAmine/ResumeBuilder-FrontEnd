        ...
        <div className="main">
          ...
          <div className="content">
            <div className="__firstPart">
              ...
              <h3 className="__subTitle __dropShadow">To Orange Digital Center Network</h3>
              <p className="par text-dark __dropShadow">
                See the latest posts from Orange Digital Center across the globe.
                Join the community to see more and be able to participate in events,
                trainings or even get your dream job!
              </p>
            </div>
